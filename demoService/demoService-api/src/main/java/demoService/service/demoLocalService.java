...
/**
 * Provides the local service interface for demo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see demoLocalServiceUtil
 * @see demoService.service.base.demoLocalServiceBaseImpl
...
public interface demoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link demoLocalServiceUtil} to access the demo local service. Add custom service methods to {@link demoService.service.impl.demoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
